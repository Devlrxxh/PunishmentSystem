...
public class MySQLDatabase implements IDatabase {
    ...
    public IDatabase load() {
        try {
            ...
            Main.instance.getLogger().severe("Failed to connect to MySQL database: " + e.getMessage());
    ...
    public DataDocument getUserData(UUID playerUUID) {
        ...
        try (PreparedStatement statement = connection.prepareStatement(query)) {
            ...
            Main.instance.getLogger().severe("Error fetching user data from MySQL: " + e.getMessage());
        }
        return null;
    }
    ...
    public void replace(UUID playerUUID, DataDocument newDocument) {
        ...
        try (PreparedStatement statement = connection.prepareStatement(updateQuery)) {
            ...
            Main.instance.getLogger().severe("Error replacing user data in MySQL: " + e.getMessage());
        }
    }
    ...
    public List<DataDocument> getAll() {
        ...
        try (PreparedStatement statement = connection.prepareStatement(query)) {
            ...
            Main.instance.getLogger().severe("Error retrieving all documents from MySQL: " + e.getMessage());
        }
        return allDocuments;
    }
